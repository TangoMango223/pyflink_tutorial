# Successful data manipulation with Flink Table API
# Start with creating a table environment

# The following code is for streaming on your local machine in a local environment
# This is NOT using Docker, Apache Flink or Kubernetes.
...
# This code handles stream data processing
...
# Datagen is the connector used to generate synthetic data for testinb
...
# Source Table - Used for inputs
# Sink Table - Used for outputting
table_env.execute_sql("""
    CREATE TABLE print (
        id INT,
        data STRING
