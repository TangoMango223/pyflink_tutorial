...
# Copy your job file to the TaskManager pod
kubectl cp word_count/stream_job.py flink-taskmanager-767498578-mwsgp:/opt/flink/stream_job.py

# Execute the job
kubectl exec -it flink-jobmanager-78bd899d97-mwdjt -- flink run /opt/flink/stream_job.py
...
"""
kubectl cp /Users/christine/VSCode/pyflink_tutorial/pyflink_tutorial/word_count flink-jobmanager-c5954b59-6jn97:/opt/flink/
